...
$num_row = $a1[$num_row2];
    ...
    $stm = $conns->prepare("SELECT id FROM posts WHERE published=true");
    $stm->execute();
...
if ($get_num > $num_pag) {
   echo "<script type='text/javascript'>window.top.location='https://www.polovnitelefoni.net/';</script>"; exit;
}else{
