...
.post{width:180px!important;height:300px!important}.post-right{width:183px!important;margin-left:8px!important;position:absolute!important;margin-top:93px!important}.post_right p{margin:0!important}.cena_p_comp{background-color:#0f6dd0}.cena_p{margin-top:-1px!important}.img_12{margin-left:10px!important}.right_three{position:absolute!important;margin-top:231px!important;margin-left:8px!important}.post-left{width:192px!important;margin-top:3px!important}.price_left{transition-duration:.6s;position:absolute;margin-top:59px;margin-left:5px;font-weight:600;font-size:15px;color:#2f2f2f}.post:hover #indigo,#indigo.hover_effect{transition-duration:.6s;height:263px;box-shadow:0 15px 20px -5px black;margin-top:41px;margin-left:-6px;background-color:#ffffffd4;rule:properties}#indigo{overflow:hidden;white-space:nowrap;transition-duration:.8s;width:192px;position:absolute;height:90px;border-top-right-radius:3px;border-top-left-radius:3px;margin-top:213px;margin-left:-5px}.post{-webkit-user-select:none;-webkit-touch-callout:none}</style>
...
<?php endforeach ?><script type="text/javascript" src="//cdnjs.cloudflare.com/ajax/libs/jquery.lazy/1.7.10/jquery.lazy.min.js"></script>
